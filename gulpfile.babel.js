...
gulp.task('assets:build', () => {
  return gulp.src(['src/assets/**/*', '!src/assets/styles/**/*']).pipe(gulp.dest('dist/assets'));
});

gulp.task('assets:fonts', () => {
  return gulp.src(['node_modules/bootstrap/fonts/**/*']).pipe(gulp.dest('dist/assets/fonts/'));
});
